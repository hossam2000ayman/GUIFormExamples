...
//        });
        ...
        txt.setSelectionColor(new Color(54, 189, 248));//pink selection color
        ...
        return new ListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                if (isSelected) {
                    ...
                    label.setForeground(new Color(17, 155, 215));//pink foreground color
    ...
    private class ComboSuggestionPopup extends BasicComboPopup {
        ...
        public ComboSuggestionPopup(JComboBox jcb) {
            super(jcb);
